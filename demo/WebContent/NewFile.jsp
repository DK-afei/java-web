					...
					<div class="col-md-9">
						<div class="form-group">
							<i class="fa fa-user fa-lg"></i> <label>用户名：</label>：<input
								...
								id="username" name="username" autofocus="autofocus" value="${cookie.username.value}"
								maxlength="20" />
						</div>
						<div class="form-group">
							<i class="fa fa-lock fa-lg"></i> <label>密码：</label><input
								class="form-control required" type="password"
								placeholder="Password" id="password" name="password" value="${cookie.password.value}"
								maxlength="8" />
						</div>
						<div class="form-group">
							<label class="checkbox"> <input type="checkbox" checked
								name="remember" />记住账号密码
							</label>
						</div>
						<div align="left">
							<div class="form-group">
								<i class="fa fa-user fa-lg"></i> <label>验证码：</label> <img
									...
									onclick="refresh()"><br>
								<br> <input class="form-control required" type="text"
